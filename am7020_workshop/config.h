...
#define MQTT_TOPIC_T        "<MQTT_TOPIC_FOR_TEMPERATURE>"
#define MQTT_TOPIC_H        "<MQTT_TOPIC_FOR_HUMIDITY>"
#define MQTT_TOPIC_LED      "<MQTT_TOPIC_FOR_LED>"
